...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-body">
                <a href="{ADMIN_EXTRAFIELDS_ALLTABLES}" class="my-3 btn btn-primary btn-sm">{PHP.L.adm_extrafields_all}</a>
                <div class="list-group">
                    <!-- BEGIN: ROW -->
                        <a href="{ADMIN_EXTRAFIELDS_ROW_TABLEURL}" class="list-group-item list-group-item-action">{ADMIN_EXTRAFIELDS_ROW_TABLENAME}</a>
                    <!-- END: ROW -->
                </div>
            </div>
        </div>
...
<div class="d-flex align-items-start">
    <div class="nav flex-column nav-pills me-3 w-25" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        <button class="nav-link" id="exAdd-tab" data-bs-toggle="pill" data-bs-target="#exAdd" type="button" role="tab"
                aria-controls="exAdd" aria-selected="true">
            {__('adm_extrafield_new')}
        </button>
        <!-- BEGIN: EXTRAFIELDS_LIST -->
        <button class="nav-link <!-- IF {PHP.ii} == 1 -->active<!-- ENDIF -->" id="ex{ADMIN_EXTRAFIELDS_ROW_ID}-tab"
                data-bs-toggle="pill" data-bs-target="#ex{ADMIN_EXTRAFIELDS_ROW_ID}" type="button" role="tab"
                aria-controls="ex{ADMIN_EXTRAFIELDS_ROW_ID}" aria-selected="true">
    ...
    <div class="tab-content w-100" id="v-pills-tabContent">
        ...
        <div class="tab-pane fade <!-- IF {PHP.ii} == 1 -->show active<!-- ENDIF -->" id="ex{ADMIN_EXTRAFIELDS_ROW_ID}"
             role="tabpanel" aria-labelledby="ex{ADMIN_EXTRAFIELDS_ROW_ID}-tab">
            <div class="card card-body">
